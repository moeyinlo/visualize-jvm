...
class JvmInvokeDynamicCallSiteRegistryTest {
    ...
    @Test
    fun `call site resolver rejects descriptors with invalid internal class names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveSpec(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "invokedynamic call site descriptor ()Ljava.lang.String; is not a method descriptor",
            exception.message,
        )
    }
    ...
    fun `bootstrap argument resolver rejects method types with field descriptors`() {
        ...
        assertEquals("invokedynamic bootstrap method type descriptor I is not a method descriptor", exception.message)
    }
    ...
    fun `bootstrap argument resolver rejects method handles with field descriptors`() {
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target descriptor I is not a method descriptor",
            exception.message,
        )
    }

    @Test
    fun `bootstrap argument resolver rejects method handles with invalid internal class names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target descriptor ()Ljava.lang.String; is not a method descriptor",
            exception.message,
        )
    }

    @Test
    fun `bootstrap argument resolver rejects method handles with invalid owner class names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
    ...
    fun `bootstrap argument resolver rejects field method handles with method descriptors`() {
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target descriptor ()I is not a field descriptor",
            exception.message,
        )
    }

    @Test
    fun `bootstrap argument resolver rejects field method handles with invalid field names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target field name bad/name is not a valid unqualified name",
            exception.message,
        )
    }
    ...
    @Test
    fun `bootstrap argument resolver rejects new invoke special method handles with non void descriptors`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target reference_kind NewInvokeSpecial " +
                "descriptor ()I must return void",
            exception.message,
        )
    }

    @Test
    fun `bootstrap argument resolver rejects ordinary invocation method handles that target constructors`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantMethodHandleEntry(
                            referenceKind = MethodHandleReferenceKind.InvokeVirtual,
                            referenceIndex = ConstantPoolIndex(7),
                        ),
                        ConstantUtf8Entry("pkg/Example", "pkg/Example".encodeToByteArray()),
                        ConstantClassEntry(ConstantPoolIndex(2)),
        ...
        assertEquals(
            "bootstrap method handle argument index #1 target reference_kind InvokeVirtual must not target <init>",
            exception.message,
        )
    }
    ...
    fun `bootstrap argument resolver rejects dynamic constants with method descriptors`() {
            ...
            JvmInvokeDynamicCallSiteResolver.resolveBootstrapArgument(
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ...
                        ConstantUtf8Entry("bad", "bad".encodeToByteArray()),
        ...
        assertEquals("invokedynamic bootstrap dynamic argument descriptor (I)V is not a field descriptor", exception.message)
    }
    ...
    fun `bootstrap argument resolver rejects dynamic constants with invalid internal class names`() {
        ...
        assertEquals(
            "invokedynamic bootstrap dynamic argument descriptor Ljava.lang.String; is not a field descriptor",
            exception.message,
        )
    }
    ...
    @Test
    fun `method handle resolver rejects method targets with invalid method names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTargetMethod(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "MethodHandle reference index #6 method name bad/name is not a valid method name",
            exception.message,
        )
    }

    @Test
    fun `method handle resolver rejects method targets with field descriptors`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTargetMethod(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "MethodHandle reference index #6 descriptor I is not a method descriptor",
            exception.message,
        )
    }
    ...
    @Test
    fun `method handle resolver rejects field targets with invalid field names`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTarget(
                constantPool = ConstantPool.fromEntries(
                    listOf(
        ...
        assertEquals(
            "MethodHandle field reference index #6 field name bad/name is not a valid unqualified name",
            exception.message,
        )
    }
    ...
    @Test
    fun `method handle resolver rejects put static targets that resolve to instance fields`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTarget(
                constantPool = bootstrapInvocationConstantPool(),
                classHierarchy = staticFieldTargetHierarchy(isStatic = false),
        ...
        assertEquals(
            "MethodHandle PutStatic target pkg/Arg.field:I resolved to a non-static field",
            exception.message,
        )
    }

    @Test
    fun `method handle resolver resolves get field targets through the class hierarchy`() {
        val target = JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTarget(
            constantPool = bootstrapInvocationConstantPool(),
            classHierarchy = staticFieldTargetHierarchy(isStatic = false),
            methodHandle = JvmMethodHandlePayload(
    ...
    @Test
    fun `method handle resolver rejects get field targets that resolve to static fields`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTarget(
                constantPool = bootstrapInvocationConstantPool(),
                classHierarchy = staticFieldTargetHierarchy(isStatic = true),
        ...
        assertEquals(
            "MethodHandle GetField target pkg/Arg.field:I resolved to a static field",
            exception.message,
        )
    }
    ...
    @Test
    fun `method handle resolver rejects invoke special targets that resolve to static methods`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTargetMethod(
                constantPool = bootstrapInvocationConstantPool(),
                classHierarchy = bootstrapTargetHierarchy(),
        ...
        assertEquals(
            "MethodHandle InvokeSpecial target pkg/Bootstrap.bootstrap:$BOOTSTRAP_DESCRIPTOR resolved to a static method",
            exception.message,
        )
    }

    @Test
    fun `method handle resolver rejects invoke special targets that resolve to constructors`() {
        val exception = assertFailsWith<JvmInvokeDynamicLinkageException> {
            JvmInvokeDynamicCallSiteResolver.resolveMethodHandleTargetMethod(
                constantPool = constructorMethodHandleConstantPool(),
                classHierarchy = JvmClassHierarchy(
        ...
        assertEquals(
            "MethodHandle InvokeSpecial target pkg/Constructed.<init>:()V must not target an initialization method",
            exception.message,
        )
    }
    ...
    fun `method handle resolver keeps unsupported reference kinds explicit`() {
        ...
        assertEquals(
            "MethodHandle reference kind PutField target resolution is not implemented yet",
            exception.message,
        )
    }
