...
class CodeNestedAttributesParserTest {
    ...
    @Test
    fun `rejects LocalVariableTable entries whose start pc does not point to an instruction opcode`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Code", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-local-variable-table-start-pc.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of(
                    "Code" to CodeAttributeParser,
    ...
    @Test
    fun `rejects LocalVariableTable entries whose index is outside max locals`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Code", byteArrayOf()),
                ConstantUtf8Entry("LocalVariableTable", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-local-variable-table-index.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of(
                    "Code" to CodeAttributeParser,
    ...
    @Test
    fun `rejects LocalVariableTypeTable entries whose index is outside max locals`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Code", byteArrayOf()),
                ConstantUtf8Entry("LocalVariableTypeTable", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-local-variable-type-table-index.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of(
                    "Code" to CodeAttributeParser,
