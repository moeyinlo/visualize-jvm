...
class RecordAttributeParserTest {
    ...
    @Test
    fun `rejects StackMapTable attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-stack-map-table.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects LineNumberTable attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-line-number-table.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
        ...
        assertTrue(failure.message.orEmpty().contains("components[0]"), failure.message)
        assertTrue(failure.message.orEmpty().contains("LineNumberTable"), failure.message)
        assertTrue(failure.message.orEmpty().contains("Code"), failure.message)
    }
    @Test
    fun `rejects LocalVariableTable attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-local-variable-table.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
        ...
        assertTrue(failure.message.orEmpty().contains("components[0]"), failure.message)
        assertTrue(failure.message.orEmpty().contains("LocalVariableTable"), failure.message)
        assertTrue(failure.message.orEmpty().contains("Code"), failure.message)
    }
    @Test
    ...
    @Test
    fun `rejects Deprecated attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-deprecated.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
        ...
        assertTrue(failure.message.orEmpty().contains("components[0]"), failure.message)
        assertTrue(failure.message.orEmpty().contains("Deprecated"), failure.message)
        assertTrue(failure.message.orEmpty().contains("ClassFile, field_info, or method_info"), failure.message)
    }
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-permitted-subclasses.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects Record attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-nested-record.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects NestMembers attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-nest-members.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects NestHost attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-nest-host.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects ModuleMainClass attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-module-main-class.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
    ...
    @Test
    fun `rejects ModulePackages attributes in record components`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("Record", byteArrayOf()),
                ConstantUtf8Entry("value", byteArrayOf()),
        ...
        val failure = assertFailsWith<ClassFileFormatException> {
            AttributeInfoParser.parseAttributes(
                reader = ClassFileByteReader(
                    ...
                    source = "bad-record-module-packages.class",
                ),
                constantPool = constantPool,
                registry = AttributeParserRegistry.of("Record" to RecordAttributeParser),
                ownerPath = "ClassFile",
