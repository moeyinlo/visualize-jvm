...
class FieldInfoParserTest {
    ...
    @Test
    fun `rejects ModulePackages attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
                    ...
                    source = "bad-field-module-packages.class",
                ),
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantUtf8Entry("value", "value".encodeToByteArray()),
    ...
    @Test
    fun `rejects ModuleMainClass attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
                    ...
                    source = "bad-field-module-main-class.class",
                ),
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantUtf8Entry("value", "value".encodeToByteArray()),
    ...
    @Test
    fun `rejects NestHost attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
                    ...
                    source = "bad-field-nest-host.class",
                ),
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantUtf8Entry("value", "value".encodeToByteArray()),
    ...
    @Test
    fun `rejects NestMembers attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
                    ...
                    source = "bad-field-nest-members.class",
                ),
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantUtf8Entry("value", "value".encodeToByteArray()),
    ...
    @Test
    fun `rejects Record attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
    ...
    @Test
    fun `rejects PermittedSubclasses attributes in field attribute tables`() {
        val failure = assertFailsWith<ClassFileFormatException> {
            FieldInfoParser.parseFields(
                reader = ClassFileByteReader(
                    byteArrayOf(
                    ...
                    source = "bad-field-permitted-subclasses.class",
                ),
                constantPool = ConstantPool.fromEntries(
                    listOf(
                        ConstantUtf8Entry("value", "value".encodeToByteArray()),
