...
| Constants execution | `nop`, `aconst_null`, and `iconst_m1..iconst_5` mutate the runtime operand stack | `jvm-interpreter`, `jvm-runtime` | `JvmInterpreterTest` | IMPLEMENTED |
