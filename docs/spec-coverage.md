...
| Constants execution | `nop`, `aconst_null`, `iconst_m1..iconst_5`, `lconst_0..lconst_1`, `fconst_0..fconst_2`, `dconst_0..dconst_1`, and `bipush` mutate the runtime operand stack | `jvm-interpreter`, `jvm-runtime` | `JvmInterpreterTest` | IMPLEMENTED |
