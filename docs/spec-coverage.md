...
| Constants execution | `nop`, `aconst_null`, `iconst_m1..iconst_5`, and `lconst_0..lconst_1` mutate the runtime operand stack | `jvm-interpreter`, `jvm-runtime` | `JvmInterpreterTest` | IMPLEMENTED |
