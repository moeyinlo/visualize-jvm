...
- Chapter 2 - JVM Structure: 26 pending row(s)
...
| --- | --- | --- | --- |
| Chapter 2 - JVM Structure | Class file format connection to runtime | `jvm-classfile`, `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Data types | `jvm-runtime` | TBD |
...
| Chapter 2 - JVM Structure | Heap | `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Method area | `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Run-time constant pool | `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Native method stacks | `jvm-native`, `jvm-jni` | TBD |
| Chapter 2 - JVM Structure | Frames | `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Local variables | `jvm-runtime`, `jvm-interpreter` | TBD |
| Chapter 2 - JVM Structure | Operand stacks | `jvm-runtime`, `jvm-interpreter` | TBD |
| Chapter 2 - JVM Structure | Dynamic linking | `jvm-runtime` | TBD |
| Chapter 2 - JVM Structure | Normal method invocation completion | `jvm-runtime`, `jvm-interpreter` | TBD |
| Chapter 2 - JVM Structure | Abrupt method invocation completion | `jvm-runtime`, `jvm-interpreter` | TBD |
| Chapter 2 - JVM Structure | Representation of objects | `jvm-runtime` | TBD |
