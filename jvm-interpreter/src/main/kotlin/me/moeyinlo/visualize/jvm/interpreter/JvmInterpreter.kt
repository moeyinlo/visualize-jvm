...
object JvmInterpreter {
    ...
    fun jniUpcallDispatcher(
        ...
        override fun callNonvirtualObjectMethod(
            ...
            return returnValue as? JvmReferenceValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualObjectMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: " +
                        "expected JvmReferenceValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
        ...
        override fun callNonvirtualBooleanMethod(
            ...
            val intValue = returnValue as? JvmIntValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualBooleanMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmIntValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
            return JvmBooleanValue(intValue.value != 0)
        ...
        override fun callNonvirtualByteMethod(
            ...
            val intValue = returnValue as? JvmIntValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualByteMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmIntValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
            return JvmByteValue(intValue.value)
        ...
        override fun callNonvirtualCharMethod(
            ...
            val intValue = returnValue as? JvmIntValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualCharMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmIntValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
            return JvmCharValue(intValue.value)
        ...
        override fun callNonvirtualIntMethod(
            ...
            return returnValue as? JvmIntValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualIntMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmIntValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
        }
        ...
        override fun callNonvirtualLongMethod(
            ...
            return returnValue as? JvmLongValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualLongMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmLongValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
        }
        ...
        override fun callNonvirtualDoubleMethod(
            ...
            return returnValue as? JvmDoubleValue
                ?: throw JvmJniUpcallException(
                    "Invalid interpreter-backed CallNonvirtualDoubleMethod return for " +
                        "${method.ownerClassName}.${method.name}:${method.descriptor}: expected JvmDoubleValue but was " +
                        (returnValue?.javaClass?.simpleName ?: "void"),
                )
        }
    ...
    private fun initializeClassForActiveUse(
        ...
        if (hostActiveUseHandler.handleActiveUse(className, classInitializationStates)) {
            return
        }
    ...
    private fun executeVirtualMethodWithArguments(
        ...
        val frameResult = executeFrame(
            ...
            monitorUnblockedHandler = monitorUnblockedHandler,
            currentClassName = targetMethod.ownerClassName,
            currentMethodName = targetMethod.name,
            currentSourceFile = targetMethod.sourceFile,
            currentLineNumberTable = targetMethod.lineNumberTable,
            allowReturn = true,
    ...
    private fun executeNativeMethod(
        ...
        receiver: JvmObjectReferenceValue?,
        arguments: List<JvmValue>,
        constantPool: ConstantPool = method.constantPool ?: ConstantPool.fromEntries(emptyList()),
        heap: JvmHeap,
        classHierarchy: JvmClassHierarchy,
        staticFields: JvmStaticFields,
        classInitializationStates: JvmClassInitializationStates = JvmClassInitializationStates(),
                ...
                ensureClassInitializedHandler = { className ->
                    initializeClassForActiveUse(
                        ...
                        activeUseStackTrace = activeUseStackTrace(
                            ...
                            activeUseBytecodeOffset = instruction.offset,
                            currentSourceFile = method.sourceFile,
                            currentLineNumberTable = method.lineNumberTable,
                        ),
                        threadScheduler = threadScheduler,
                        hostActiveUseHandler = hostActiveUseHandler,
                    ) { classInitializer ->
                        executeStaticMethodWithArguments(
                            instruction = instruction,
                            constantPool = classInitializer.constantPool ?: constantPool,
                            heap = heap,
                            classHierarchy = classHierarchy,
                            staticFields = staticFields,
                            classInitializationStates = classInitializationStates,
    ...
    private fun executeStaticMethodUpcall(
        ...
        val upcallInstruction = DecodedInstruction(
            offset = -1,
            metadata = OpcodeTable.metadata(0xB8.toByte()),
            operands = emptyList(),
        )
        initializeClassForActiveUse(
            resolvedMethod.ownerClassName,
            ...
            activeUseStackTrace = activeUseStackTrace(
                currentClassName = currentClassName,
                currentMethodName = "<native-upcall>",
            ),
            threadScheduler = threadScheduler,
        ) { classInitializer ->
            executeStaticMethodWithArguments(
                instruction = upcallInstruction,
