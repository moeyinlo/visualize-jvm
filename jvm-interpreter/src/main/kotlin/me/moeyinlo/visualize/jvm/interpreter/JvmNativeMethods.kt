...
object JvmVmIntrinsics {
    ...
    private val ClassGetClassAccessFlagsRaw0Key = JvmNativeMethodKey(
        ownerClassName = "java/lang/Class",
    ...
    private val ClassIsAssignableFrom = JvmNativeMethodIntrinsic { context, invocation ->
        val targetClassPayload = requireClassMirrorReceiverPayloadWithArguments(
            "Class.isAssignableFrom",
            context,
            invocation,
        )
        val targetClassName = targetClassPayload.representedClassName
        if (invocation.arguments.size != 1) {
        ...
        val sourceMirror = invocation.arguments.single() as? JvmObjectReferenceValue
            ?: throw JvmUnsupportedInstructionException("Class.isAssignableFrom expects one Class mirror argument")
        val sourceClassPayload = requireClassMirrorPayload("Class.isAssignableFrom argument", context, sourceMirror)
        val assignable = classMirrorAssignable(context, sourceClassPayload, targetClassPayload)
    ...
    private val ClassGetInterfaces0 = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        val interfaceNames = when {
            ...
            else -> classDefinition?.interfaceNames
                ?: context.classHierarchy.directSuperinterfaceNames(representedClassName)
        }
    ...
    private val UnsafeGetReferenceVolatile = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (!field.descriptor.isReferenceDescriptor()) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getReferenceVolatile object field offset must map to a reference field",
                )
            }
            return@JvmNativeMethodIntrinsic context.heap.getInstanceField(base, field) as? JvmReferenceValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.getReferenceVolatile object field did not contain a reference value",
                )
        }
        if (base != JvmNullValue) {
            throw JvmUnsupportedInstructionException(
    ...
    private val UnsafeCompareAndExchangeReference = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (!field.descriptor.isReferenceDescriptor()) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeReference object field offset must map to a reference field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmReferenceValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeReference object field did not contain a reference value",
                )
            if (current == expected) {
                context.heap.putInstanceField(base, field, replacement)
            }
    ...
    private val UnsafePutFloatVolatile = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "F") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.putFloatVolatile object field offset must map to a float field",
                )
            }
            context.heap.putInstanceField(base, field, value)
            return@JvmNativeMethodIntrinsic null
    ...
    private val UnsafePutDoubleVolatile = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "D") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.putDoubleVolatile object field offset must map to a double field",
                )
            }
            context.heap.putInstanceField(base, field, value)
            return@JvmNativeMethodIntrinsic null
    ...
    private val UnsafeCompareAndSetInt = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "I") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetInt object field offset must map to an int field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetInt object field did not contain an int value",
                )
    ...
    private val UnsafeCompareAndSetLong = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "J") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetLong object field offset must map to a long field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmLongValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetLong object field did not contain a long value",
                )
            if (current.value != expected.value) {
                return@JvmNativeMethodIntrinsic JvmIntValue(0)
            }
    ...
    private val UnsafeCompareAndSetFloat = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "F") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetFloat object field offset must map to a float field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmFloatValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetFloat object field did not contain a float value",
                )
            if (current.value.toRawBits() != expected.value.toRawBits()) {
                return@JvmNativeMethodIntrinsic JvmIntValue(0)
            }
    ...
    private val UnsafeCompareAndSetChar = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "C") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetChar object field offset must map to a char field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndSetChar object field did not contain a char-compatible int value",
                )
            if (current.value !in Char.MIN_VALUE.code..Char.MAX_VALUE.code) {
                throw JvmUnsupportedInstructionException("Unsafe.compareAndSetChar object field char value is out of range")
            }
            if (current.value != expected.value) {
                return@JvmNativeMethodIntrinsic JvmIntValue(0)
            }
    ...
    private val UnsafeCompareAndExchangeLong = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "J") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeLong object field offset must map to a long field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmLongValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeLong object field did not contain a long value",
                )
            if (current.value == expected.value) {
                context.heap.putInstanceField(base, field, replacement)
            }
    ...
    private val UnsafeGetAndAddLong = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "J") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndAddLong object field offset must map to a long field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmLongValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndAddLong object field did not contain a long value",
                )
            context.heap.putInstanceField(base, field, JvmLongValue(current.value + delta.value))
            return@JvmNativeMethodIntrinsic current
        }
        if (base != JvmNullValue) {
            throw JvmUnsupportedInstructionException(
    ...
    private val UnsafeGetAndSetInt = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "I") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetInt object field offset must map to an int field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetInt object field did not contain an int value",
                )
            context.heap.putInstanceField(base, field, replacement)
            return@JvmNativeMethodIntrinsic current
        }
    ...
    private val UnsafeGetAndSetBoolean = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "Z") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetBoolean object field offset must map to a boolean field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetBoolean object field did not contain a boolean-compatible int value",
                )
            if (current.value !in 0..1) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetBoolean object field boolean value must be 0 or 1",
                )
            }
            context.heap.putInstanceField(base, field, replacement)
            return@JvmNativeMethodIntrinsic current
    ...
    private val UnsafeGetAndSetShort = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "S") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetShort object field offset must map to a short field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetShort object field did not contain a short-compatible int value",
                )
            if (current.value !in Short.MIN_VALUE.toInt()..Short.MAX_VALUE.toInt()) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.getAndSetShort object field short value is out of range",
                )
            }
            context.heap.putInstanceField(base, field, replacement)
            return@JvmNativeMethodIntrinsic current
    ...
    private val UnsafeCompareAndExchangeDouble = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "D") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeDouble object field offset must map to a double field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmDoubleValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeDouble object field did not contain a double value",
                )
            if (current.value.toRawBits() == expected.value.toRawBits()) {
                context.heap.putInstanceField(base, field, replacement)
            }
    ...
    private val UnsafeCompareAndExchangeBoolean = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "Z") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeBoolean object field offset must map to a boolean field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeBoolean object field did not contain a boolean-compatible int value",
                )
            if (current.value !in 0..1) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeBoolean object field boolean value must be 0 or 1",
                )
            }
            if (current.value == expected.value) {
                context.heap.putInstanceField(base, field, replacement)
    ...
    private val UnsafeCompareAndExchangeByte = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "B") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeByte object field offset must map to a byte field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeByte object field did not contain a byte-compatible int value",
                )
            if (current.value !in Byte.MIN_VALUE.toInt()..Byte.MAX_VALUE.toInt()) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeByte object field byte value is out of range",
                )
            }
            if (current.value == expected.value) {
                context.heap.putInstanceField(base, field, replacement)
    ...
    private val UnsafeCompareAndExchangeShort = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            if (field.descriptor != "S") {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeShort object field offset must map to a short field",
                )
            }
            val current = context.heap.getInstanceField(base, field) as? JvmIntValue
                ?: throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeShort object field did not contain a short-compatible int value",
                )
            if (current.value !in Short.MIN_VALUE.toInt()..Short.MAX_VALUE.toInt()) {
                throw JvmUnsupportedInstructionException(
                    "Unsafe.compareAndExchangeShort object field short value is out of range",
                )
            }
            if (current.value == expected.value) {
                context.heap.putInstanceField(base, field, replacement)
        ...
        if (base is JvmObjectReferenceValue) {
            ...
            when (val payload = heapObject.payload) {
                ...
                is JvmCharArrayPayload -> {
                    payload.setRawBytes(
                        operation = "Unsafe.setMemory0 char array",
                        start = start,
                        endExclusive = endExclusive,
                        value = value.value.toByte(),
                    )
                ...
                is JvmFloatArrayPayload -> {
                    payload.setRawBytes(
                        operation = "Unsafe.setMemory0 float array",
                        start = start,
                        endExclusive = endExclusive,
                        value = value.value.toByte(),
                    )
    ...
    private val UnsafeCopyMemory0 = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (sourceBase == JvmNullValue && targetBase is JvmObjectReferenceValue) {
            ...
            when (targetPayload) {
                is JvmByteArrayPayload -> {
                    if (targetStart < 0L || targetEndExclusive < targetStart || targetEndExclusive > targetPayload.elements.size) {
                ...
                is JvmBooleanArrayPayload -> {
                    ...
                    val snapshot = (0L until bytes.value)
                        .map { offset -> context.unsafeMemory.nativeMemoryByte(sourceOffset.value + offset) }
                    snapshot.forEachIndexed { index, byte ->
                        if (byte.toInt() !in 0..1) {
                            throw JvmUnsupportedInstructionException(
                                "Unsafe.copyMemory0 boolean array source bytes must be 0 or 1",
                            )
                        }
                        targetPayload.elements[targetStart.toInt() + index] = byte.toInt() == 1
                    }
                }
                is JvmShortArrayPayload -> {
                    val snapshot = (0L until bytes.value)
                ...
                is JvmFloatArrayPayload -> {
                    val snapshot = (0L until bytes.value)
                        .map { offset -> context.unsafeMemory.nativeMemoryByte(sourceOffset.value + offset) }
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copyMemory0 float array target",
                        start = targetStart,
                        bytes = snapshot,
                    )
                }
                is JvmLongArrayPayload -> {
                    val snapshot = (0L until bytes.value)
                        .map { offset -> context.unsafeMemory.nativeMemoryByte(sourceOffset.value + offset) }
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copyMemory0 long array target",
                        start = targetStart,
                        bytes = snapshot,
                    )
                }
                is JvmDoubleArrayPayload -> {
                    val snapshot = (0L until bytes.value)
                        .map { offset -> context.unsafeMemory.nativeMemoryByte(sourceOffset.value + offset) }
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copyMemory0 double array target",
                        start = targetStart,
                        bytes = snapshot,
                    )
                }
                else -> throw JvmUnsupportedInstructionException(
                    "Unsafe.copyMemory0 currently supports only guest byte, boolean, char, double, float, int, long, or short arrays for non-null bases",
                )
            }
            return@JvmNativeMethodIntrinsic null
        }
        if (sourceBase is JvmObjectReferenceValue && targetBase == JvmNullValue) {
            ...
            when (sourcePayload) {
                ...
                is JvmFloatArrayPayload -> {
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 float array source",
                        start = sourceStart,
                        endExclusive = sourceEndExclusive,
                    )
                    snapshot.forEachIndexed { index, byte ->
                ...
                is JvmLongArrayPayload -> {
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 long array source",
                        start = sourceStart,
                        endExclusive = sourceEndExclusive,
                    )
                    snapshot.forEachIndexed { index, byte ->
                ...
                is JvmDoubleArrayPayload -> {
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 double array source",
                        start = sourceStart,
                        endExclusive = sourceEndExclusive,
                    )
                    snapshot.forEachIndexed { index, byte ->
            ...
            when (sourcePayload) {
                ...
                is JvmFloatArrayPayload -> {
                    val floatTargetPayload = targetPayload as? JvmFloatArrayPayload
                        ?: throw JvmUnsupportedInstructionException(
                            "Unsafe.copyMemory0 currently supports only matching guest byte, boolean, char, float, int, or short arrays",
                        )
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 float array source",
                        start = sourceStart,
                    ...
                    floatTargetPayload.setRawBytes(
                        operation = "Unsafe.copyMemory0 float array target",
                        start = targetStart,
                        bytes = snapshot,
                    )
                ...
                is JvmLongArrayPayload -> {
                    val longTargetPayload = targetPayload as? JvmLongArrayPayload
                        ?: throw JvmUnsupportedInstructionException(
                            "Unsafe.copyMemory0 currently supports only matching guest byte, boolean, char, float, int, long, or short arrays",
                        )
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 long array source",
                        start = sourceStart,
                ...
                is JvmDoubleArrayPayload -> {
                    val doubleTargetPayload = targetPayload as? JvmDoubleArrayPayload
                        ?: throw JvmUnsupportedInstructionException(
                            "Unsafe.copyMemory0 currently supports only matching guest byte, boolean, char, double, float, int, long, or short arrays",
                        )
                    val snapshot = sourcePayload.rawBytes(
                        operation = "Unsafe.copyMemory0 double array source",
                        start = sourceStart,
    ...
    private val UnsafeCopySwapMemory0 = JvmNativeMethodIntrinsic { context, invocation ->
        ...
        if (sourceBase == JvmNullValue && targetBase is JvmObjectReferenceValue) {
            ...
            when (targetPayload) {
                ...
                is JvmCharArrayPayload -> {
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copySwapMemory0 char array target",
                        start = targetStart,
                        bytes = snapshot.swappedRawBytes(elementSize.value),
                    )
                }
                is JvmIntArrayPayload -> {
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copySwapMemory0 int array target",
                        start = targetStart,
                        bytes = snapshot.swappedRawBytes(elementSize.value),
                    )
                }
                is JvmFloatArrayPayload -> {
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copySwapMemory0 float array target",
                        start = targetStart,
                        bytes = snapshot.swappedRawBytes(elementSize.value),
                    )
                }
                is JvmLongArrayPayload -> {
                    targetPayload.setRawBytes(
                        operation = "Unsafe.copySwapMemory0 long array target",
                        start = targetStart,
                        bytes = snapshot.swappedRawBytes(elementSize.value),
                    )
                }
        ...
        if (sourceBase is JvmObjectReferenceValue && targetBase == JvmNullValue) {
            ...
            val sourceStart = sourceOffset.value - UnsafeSyntheticArrayBaseOffset
            val sourceEndExclusive = sourceStart + bytes.value
            for (offset in 0L until bytes.value) {
                context.unsafeMemory.nativeMemoryByte(targetOffset.value + offset)
            }
            val swapped = when (sourcePayload) {
                is JvmByteArrayPayload -> {
                    if (
                        sourceStart < 0L ||
                    ...
                    (sourceStart.toInt() until sourceEndExclusive.toInt())
                        .map { index -> sourcePayload.elements[index] }
    ...
    private fun requireClassMirrorReceiverPayloadWithArguments(
        name: String,
        context: JvmNativeMethodContext,
        invocation: JvmNativeMethodInvocation,
    ): JvmClassPayload {
    ...
    private fun classMirrorAssignable(
        context: JvmNativeMethodContext,
        sourcePayload: JvmClassPayload,
        targetPayload: JvmClassPayload,
    ): Boolean {
        val sourceClassName = sourcePayload.representedClassName
        val targetClassName = targetPayload.representedClassName
        if (sourceClassName in PrimitiveClassNames || targetClassName in PrimitiveClassNames) {
    ...
    private fun JvmCharArrayPayload.setRawBytes(
        ...
        val byteSize = elements.size.toLong() * Char.SIZE_BYTES.toLong()
        if (start < 0L || endExclusive < start || endExclusive > byteSize) {
            throw JvmUnsupportedInstructionException("$operation range is outside array bounds")
        }
        for (rawOffset in start until endExclusive) {
    ...
    private fun JvmFloatArrayPayload.setRawBytes(
        operation: String,
        start: Long,
        endExclusive: Long,
        value: Byte,
    ) {
        val byteSize = elements.size.toLong() * Float.SIZE_BYTES.toLong()
        if (start < 0L || endExclusive < start || endExclusive > byteSize) {
            throw JvmUnsupportedInstructionException("$operation range is outside array bounds")
        }
        for (rawOffset in start until endExclusive) {
            val elementIndex = (rawOffset / Float.SIZE_BYTES).toInt()
            val byteIndex = (rawOffset % Float.SIZE_BYTES).toInt()
            elements[elementIndex] = elements[elementIndex]
                .toRawBits()
                .replaceSyntheticNativeByte(
                    byteIndex = byteIndex,
                    elementBytes = Float.SIZE_BYTES,
                    value = value,
                )
                .let(Float.Companion::fromBits)
        }
    }

    private fun JvmFloatArrayPayload.rawBytes(
        operation: String,
        start: Long,
        endExclusive: Long,
    ): List<Byte> {
        validateRawByteRange(
            ...
            start = start,
            endExclusive = endExclusive,
            byteSize = elements.size.toLong() * Float.SIZE_BYTES.toLong(),
        )
        return (start until endExclusive).map { rawOffset ->
            val elementIndex = (rawOffset / Float.SIZE_BYTES).toInt()
            val byteIndex = (rawOffset % Float.SIZE_BYTES).toInt()
            val shift = syntheticNativeByteShift(byteIndex = byteIndex, elementBytes = Float.SIZE_BYTES)
            ((elements[elementIndex].toRawBits() ushr shift) and 0xff).toByte()
        }
    }
    ...
    private fun JvmLongArrayPayload.rawBytes(
        operation: String,
        start: Long,
        endExclusive: Long,
    ): List<Byte> {
        validateRawByteRange(
            ...
            start = start,
            endExclusive = endExclusive,
            byteSize = elements.size.toLong() * Long.SIZE_BYTES.toLong(),
        )
        return (start until endExclusive).map { rawOffset ->
            val elementIndex = (rawOffset / Long.SIZE_BYTES).toInt()
            val byteIndex = (rawOffset % Long.SIZE_BYTES).toInt()
            val shift = syntheticNativeByteShift(byteIndex = byteIndex, elementBytes = Long.SIZE_BYTES)
            ((elements[elementIndex] ushr shift) and 0xff).toByte()
        }
    }
    ...
    private fun JvmDoubleArrayPayload.rawBytes(
        operation: String,
        start: Long,
        endExclusive: Long,
    ): List<Byte> {
        validateRawByteRange(
            ...
            start = start,
            endExclusive = endExclusive,
            byteSize = elements.size.toLong() * Double.SIZE_BYTES.toLong(),
        )
        return (start until endExclusive).map { rawOffset ->
            val elementIndex = (rawOffset / Double.SIZE_BYTES).toInt()
            val byteIndex = (rawOffset % Double.SIZE_BYTES).toInt()
            val shift = syntheticNativeByteShift(byteIndex = byteIndex, elementBytes = Double.SIZE_BYTES)
            ((elements[elementIndex].toRawBits() ushr shift) and 0xff).toByte()
        }
    }
