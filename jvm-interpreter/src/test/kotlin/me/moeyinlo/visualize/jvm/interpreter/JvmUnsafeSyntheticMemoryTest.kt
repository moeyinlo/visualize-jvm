...
class JvmUnsafeSyntheticMemoryTest {
    ...
    @Test
    fun `synthetic static long slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticLongSlots = mapOf(7L to 42L))

        assertEquals(42L, memory.getAndSetStaticLong(offset = 7L, replacement = 43L))
        assertEquals(43L, memory.getStaticLong(offset = 7L))
        assertEquals(0L, memory.getAndSetStaticLong(offset = 9L, replacement = -3L))
        assertEquals(-3L, memory.getStaticLong(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static int slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticIntSlots = mapOf(7L to 42))

        assertEquals(42, memory.getAndSetStaticInt(offset = 7L, replacement = 43))
        assertEquals(43, memory.getStaticInt(offset = 7L))
        assertEquals(0, memory.getAndSetStaticInt(offset = 9L, replacement = -3))
        assertEquals(-3, memory.getStaticInt(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static boolean slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticBooleanSlots = mapOf(7L to true))

        assertEquals(true, memory.getAndSetStaticBoolean(offset = 7L, replacement = false))
        assertEquals(false, memory.getStaticBoolean(offset = 7L))
        assertEquals(false, memory.getAndSetStaticBoolean(offset = 9L, replacement = true))
        assertEquals(true, memory.getStaticBoolean(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static byte slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticByteSlots = mapOf(7L to 42.toByte()))

        assertEquals(42.toByte(), memory.getAndSetStaticByte(offset = 7L, replacement = 43.toByte()))
        assertEquals(43.toByte(), memory.getStaticByte(offset = 7L))
        assertEquals(0.toByte(), memory.getAndSetStaticByte(offset = 9L, replacement = (-3).toByte()))
        assertEquals((-3).toByte(), memory.getStaticByte(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static short slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticShortSlots = mapOf(7L to 42.toShort()))

        assertEquals(42.toShort(), memory.getAndSetStaticShort(offset = 7L, replacement = 43.toShort()))
        assertEquals(43.toShort(), memory.getStaticShort(offset = 7L))
        assertEquals(0.toShort(), memory.getAndSetStaticShort(offset = 9L, replacement = (-3).toShort()))
        assertEquals((-3).toShort(), memory.getStaticShort(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static char slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticCharSlots = mapOf(7L to 'A'))

        assertEquals('A', memory.getAndSetStaticChar(offset = 7L, replacement = 'B'))
        assertEquals('B', memory.getStaticChar(offset = 7L))
        assertEquals('\u0000', memory.getAndSetStaticChar(offset = 9L, replacement = 'C'))
        assertEquals('C', memory.getStaticChar(offset = 9L))
    }
    ...
    @Test
    fun `synthetic static float slots get and set returns witness value`() {
        val memory = JvmUnsafeSyntheticMemory(staticFloatSlots = mapOf(7L to 42.0f))

        assertEquals(42.0f, memory.getAndSetStaticFloat(offset = 7L, replacement = 43.0f))
        assertEquals(43.0f, memory.getStaticFloat(offset = 7L))
        assertEquals(0.0f, memory.getAndSetStaticFloat(offset = 9L, replacement = -3.0f))
        assertEquals(-3.0f, memory.getStaticFloat(offset = 9L))
    }
