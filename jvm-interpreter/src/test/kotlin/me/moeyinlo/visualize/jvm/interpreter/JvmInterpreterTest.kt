...
import me.moeyinlo.visualize.jvm.runtime.JvmInvokeDynamicCallSiteSpec
...
class JvmInterpreterTest {
    ...
    @Test
    fun `execute can start with preloaded operand stack values`() {
        val result = JvmInterpreter.execute(
            code = byteArrayOf(
                0x06.toByte(),
                0x60.toByte(),
            ...
            maxStack = 2,
            initialOperandStackValues = listOf(JvmIntValue(2)),
        )
    ...
    @Test
    fun `scheduled thread execution API can start with preloaded operand stack values`() {
    ...
    @Test
    fun `new executes class initializer before allocating object`() {
        val heap = JvmHeap()
        val initializationStates = JvmClassInitializationStates()
        ...
        assertFalse(heap.isInitialized(reference))
        assertEquals("example/Foo", heap.get(reference).className)
        assertEquals(JvmIntValue(1), staticFields.get(initializedField))
        assertEquals(JvmClassInitializationState.Initialized, initializationStates.get("example/Foo"))
    }
    ...
    @Test
    fun `getstatic executes class initializer before reading static field`() {
        val initializationStates = JvmClassInitializationStates()
    ...
    @Test
    fun `putstatic executes class initializer before storing static field`() {
        val initializationStates = JvmClassInitializationStates()
        val staticFields = JvmStaticFields()
        val counterField = JvmFieldReference(
            ownerClassName = "Example",
            name = "counter",
            descriptor = "I",
        )
        ...
        assertEquals(0, result.operandStack.slotDepth)
        assertEquals(0, result.operandStack.valueCount)
        assertEquals(JvmIntValue(5), staticFields.get(counterField))
        assertEquals(JvmIntValue(1), staticFields.get(initializedField))
        assertEquals(JvmClassInitializationState.Initialized, initializationStates.get("Example"))
    }
    ...
    @Test
    fun `ldc dynamic constant native bootstrap retains native library load hook`() {
        val dynamicConstants = JvmDynamicConstantRegistry()
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Bootstrap", "bootstrap", dynamicConstantIntBootstrapDescriptor, isStatic = true) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    ...
                    context.loadNativeLibraryHandler("condy-bootstrap-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("condy-bootstrap-native"), loadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
        assertEquals(JvmIntValue(42), dynamicConstants.resolved(JvmRuntimeConstantPoolIndex(1)))
    }
    ...
    @Test
    fun `invokestatic executes class initializer before invoking static method`() {
        val initializationStates = JvmClassInitializationStates()
    ...
    fun `invokestatic executes loaded native library static exports`() {
        ...
        var invokedClassName: String? = null
        ...
        val result = JvmInterpreter.execute(
            ...
            nativeMethods = JvmNativeMethodRegistry.fromLoadedNativeLibraries(
                ...
                invokeDowncall = { invocation ->
                    ...
                    invokedClassName = environment.handles.resolveClass(classArgument.handle)
        ...
        assertEquals("NativeOwner", invokedClassName)
    }
    ...
    fun `loaded native library exports run inside an automatic JNI local frame`() {
        ...
        val returnReference = heap.allocateObject("java/lang/String")
        val localVariables = JvmLocalVariables(maxLocals = 1)
        localVariables.store(0, inputReference)
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "NativeOwner",
        ...
        val export = JvmNativeMethodExportDescriptor(
            ownerClassName = "NativeOwner",
            methodName = "nativeObject",
            methodDescriptor = "(Ljava/lang/Object;)Ljava/lang/Object;",
            isStatic = true,
            symbolName = "Java_NativeOwner_nativeObject__Ljava_lang_Object_2",
        )
        val library = JvmNativeLibraryDescriptor(
            logicalName = "native-api",
            path = Path.of("native-api.dll"),
        ...
        val result = JvmInterpreter.execute(
            ...
            constantPool = ConstantPool.fromEntries(
                listOf(
                    ...
                    ConstantUtf8Entry("NativeOwner", "NativeOwner".encodeToByteArray()),
                    ConstantNameAndTypeEntry(ConstantPoolIndex(5), ConstantPoolIndex(6)),
                    ConstantUtf8Entry("nativeObject", "nativeObject".encodeToByteArray()),
                    ConstantUtf8Entry("(Ljava/lang/Object;)Ljava/lang/Object;", "(Ljava/lang/Object;)Ljava/lang/Object;".encodeToByteArray()),
                ),
            ),
            heap = heap,
            localVariables = localVariables,
            ...
            nativeMethods = JvmNativeMethodRegistry.fromLoadedNativeLibraries(
                ...
                invokeDowncall = { invocation ->
                    ...
                    assertEquals(1, environment.handles.localFrameDepth)
                    assertEquals(target, invocation.target)
                    val classArgument = invocation.arguments[1] as JvmNativeDowncallArgument.ClassHandle
                    assertEquals("NativeOwner", environment.handles.resolveClass(classArgument.handle))
                    val objectArgument = invocation.arguments[2] as JvmNativeDowncallArgument.ObjectHandle
                    assertEquals(inputReference, environment.handles.resolveObject(objectArgument.handle!!))
                    JvmNativeDowncallReturn.ObjectHandle(environment.handles.newObjectHandle(returnReference))
                },
            ),
            currentClassName = "Caller",
        )

        assertEquals(listOf(returnReference), result.operandStack.toList())
    ...
    @Test
    fun `invokevirtual executes loaded native library instance exports`() {
        val heap = JvmHeap()
        ...
        val invocations = mutableListOf<JvmNativeDowncallInvocation>()
        var invokedReceiver: JvmObjectReferenceValue? = null
        ...
        val result = JvmInterpreter.execute(
            ...
            nativeMethods = JvmNativeMethodRegistry.fromLoadedNativeLibraries(
                ...
                invokeDowncall = { invocation ->
                    ...
                    invokedReceiver = environment.handles.resolveObject(receiverArgument.handle!!)
                    JvmNativeDowncallReturn.IntPrimitive(43)
                },
            ),
            currentClassName = "Caller",
        )

        assertEquals(listOf(JvmIntValue(43)), result.operandStack.toList())
        val invocation = invocations.single()
        assertEquals(target, invocation.target)
        assertTrue(invocation.arguments[0] is JvmNativeDowncallArgument.SimulatedJniEnv)
        assertEquals(receiver, invokedReceiver)
    }
    ...
    @Test
    fun `native static upcalls retain native library unload hook`() {
        val heap = JvmHeap()
        val unloadedLogicalNames = mutableListOf<String>()
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            ...
            JvmNativeMethodKey("NativeLibraryBridge", "unload", "(Ljava/lang/String;)V", isStatic = true) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    val libraryName = context.heap.get(invocation.arguments.single() as JvmObjectReferenceValue)
                        .payload as JvmStringPayload
                    context.unloadNativeLibraryHandler(libraryName.value)
                    null
                },
        )
        ...
        assertEquals(listOf("upcall-native"), unloadedLogicalNames)
    }
    ...
    fun `invokeinterface native methods retain native library load hook`() {
        ...
        val libraryName = heap.internString("interface-native")
        val localVariables = JvmLocalVariables(maxLocals = 2)
        localVariables.store(0, receiver)
        localVariables.store(1, libraryName)
        val loadedLogicalNames = mutableListOf<String>()
        ...
        JvmInterpreter.execute(
            ...
            constantPool = ConstantPool.fromEntries(
                listOf(
                    ...
                    ConstantNameAndTypeEntry(ConstantPoolIndex(5), ConstantPoolIndex(6)),
                    ConstantUtf8Entry("loadInterface", "loadInterface".encodeToByteArray()),
                    ConstantUtf8Entry(
                        "(Ljava/lang/String;)V",
                        "(Ljava/lang/String;)V".encodeToByteArray(),
                    ),
        ...
        assertEquals(listOf("interface-native"), loadedLogicalNames)
    }
    ...
    fun `native instance upcalls retain native library load hook`() {
            ...
            JvmNativeMethodKey("NativeOwner", "entry", "(LUpcaller;)V", isStatic = true) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    context.callInstanceMethod(
                        ...
                        name = "load",
                        descriptor = "(Ljava/lang/String;)V",
                        arguments = listOf(context.heap.internString("instance-upcall-native")),
                    )
                    null
                },
            JvmNativeMethodKey("NativeLibraryBridge", "load", "(Ljava/lang/String;)V", isStatic = true) to
        ...
        assertEquals(listOf("instance-upcall-native"), loadedLogicalNames)
    }

    @Test
    fun `native instance upcalls retain native library unload hook`() {
        val heap = JvmHeap()
        val upcaller = heap.allocateObject("Upcaller")
        val localVariables = JvmLocalVariables(maxLocals = 1)
        localVariables.store(0, upcaller)
        ...
        assertEquals(listOf("instance-upcall-native"), unloadedLogicalNames)
    }
    ...
    fun `invokestatic executes registered native static methods from loaded libraries`() {
        ...
        val result = JvmInterpreter.execute(
            ...
            nativeMethods = JvmNativeMethodRegistry.fromLoadedNativeLibraries(
                ...
                invokeDowncall = { invocation ->
                    ...
                    val classArgument = invocation.arguments[1] as JvmNativeDowncallArgument.ClassHandle
                    invokedClassName = environment.handles.resolveClass(classArgument.handle)
                    JvmNativeDowncallReturn.IntPrimitive(44)
                },
            ),
            currentClassName = "Caller",
        )
        ...
        assertEquals(0xCAFE_BABEL, invocation.target.address)
    ...
    @Test
    fun `interpreter backed JNI dispatcher routes instance int upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        assertEquals(JvmIntValue(5), dispatcher.callIntMethod(receiver, method, emptyList()))
    }
    ...
    fun `interpreter backed JNI dispatcher routes static int upcalls into guest methods`() {
        ...
        assertEquals(JvmIntValue(5), dispatcher.callStaticIntMethod(method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes instance void upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val monitors = JvmMonitorState()
        val classHierarchy = JvmClassHierarchy(
        ...
        dispatcher.callVoidMethod(receiver, method, emptyList())

        assertEquals(1, monitors.holdCount(receiver, "jni-thread"))
    }
    ...
    fun `interpreter backed JNI dispatcher routes static void upcalls into guest methods`() {
        ...
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(internalName = "NativeOwner"),
                JvmClassDefinition(
                    internalName = "StaticOwner",
                    methods = listOf(
                        JvmMethodDefinition(
                            name = "enter",
                            descriptor = "(LNativeOwner;)V",
                            isStatic = true,
                            code = byteArrayOf(
                                0x2A.toByte(),
                                0xC2.toByte(),
        ...
        dispatcher.callStaticVoidMethod(method, listOf(receiver))

        assertEquals(1, monitors.holdCount(receiver, "jni-thread"))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes instance object upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        assertEquals(receiver, dispatcher.callObjectMethod(receiver, method, emptyList()))
    }
            ...
            listOf(
                ...
                JvmClassDefinition(
                    ...
                    methods = listOf(
                        JvmMethodDefinition(
                            name = "same",
                            descriptor = "(LNativeOwner;)LNativeOwner;",
                            isStatic = true,
                            code = byteArrayOf(
                                0x2A.toByte(),
                                0xB0.toByte(),
    ...
    @Test
    fun `interpreter backed JNI dispatcher routes static boolean upcalls into guest methods`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "StaticOwner",
        ...
        assertEquals(JvmBooleanValue(false), dispatcher.callStaticBooleanMethod(method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes instance byte upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        assertEquals(JvmByteValue(-7), dispatcher.callByteMethod(receiver, method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes static byte upcalls into guest methods`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "StaticOwner",
    ...
    @Test
    fun `interpreter backed JNI dispatcher routes instance float upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        assertEquals(JvmFloatValue(2.0f), dispatcher.callFloatMethod(receiver, method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes instance double upcalls into guest methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("NativeOwner")
        val classHierarchy = JvmClassHierarchy(
            listOf(
    ...
    fun `interpreter backed JNI dispatcher routes static char upcalls into guest methods`() {
        ...
        assertEquals(JvmCharValue('Z'.code), dispatcher.callStaticCharMethod(method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes static short upcalls into guest methods`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "StaticOwner",
        ...
        assertEquals(JvmShortValue(34), dispatcher.callStaticShortMethod(method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes static long upcalls into guest methods`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "StaticOwner",
        ...
        assertEquals(JvmLongValue(0L), dispatcher.callStaticLongMethod(method, emptyList()))
    }

    @Test
    fun `interpreter backed JNI dispatcher routes static float upcalls into guest methods`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
                    internalName = "StaticOwner",
        ...
        assertEquals(JvmFloatValue(1.0f), dispatcher.callStaticFloatMethod(method, emptyList()))
    }
    ...
    @Test
    fun `invokevirtual selects private resolved method without subclass override lookup`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("Sub")
        val callerLocals = JvmLocalVariables(maxLocals = 1)
        callerLocals.store(0, receiver)
    ...
    @Test
    fun `invokevirtual ignores static methods that cannot override resolved methods`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("Sub")
        val callerLocals = JvmLocalVariables(maxLocals = 1)
        callerLocals.store(0, receiver)
    ...
    @Test
    fun `invokevirtual skips package private methods from different packages`() {
        val heap = JvmHeap()
    ...
    @Test
    fun `invokespecial executes callee bytecode with the callee method constant pool`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Owner")
        val callerLocals = JvmLocalVariables(maxLocals = 1)
        callerLocals.store(0, receiver)
    ...
    @Test
    fun `invokevirtual interpreted callee retains monitor unblocked hook`() {
        val heap = JvmHeap()
        val monitor = JvmMonitorState()
        val receiver = heap.allocateObject("pkg/Lock")
        val localVariables = JvmLocalVariables(maxLocals = 1)
        ...
        val result = JvmInterpreter.execute(
            ...
            constantPool = ConstantPool.fromEntries(
                listOf(
                    ConstantMethodRefEntry(ConstantPoolIndex(2), ConstantPoolIndex(4)),
                    ConstantClassEntry(ConstantPoolIndex(3)),
                    ConstantUtf8Entry("pkg/Lock", "pkg/Lock".encodeToByteArray()),
                    ConstantNameAndTypeEntry(ConstantPoolIndex(5), ConstantPoolIndex(6)),
                    ConstantUtf8Entry("release", "release".encodeToByteArray()),
                    ConstantUtf8Entry("()V", "()V".encodeToByteArray()),
                ),
    ...
    @Test
    fun `invokespecial interpreted callee retains monitor unblocked hook`() {
        val heap = JvmHeap()
        val monitor = JvmMonitorState()
        val receiver = heap.allocateObject("pkg/Lock")
        val localVariables = JvmLocalVariables(maxLocals = 1)
    ...
    @Test
    fun `invokeinterface interpreted callee retains monitor unblocked hook`() {
        val heap = JvmHeap()
        val monitor = JvmMonitorState()
    ...
    @Test
    fun `multianewarray throws guest NegativeArraySizeException for negative counts`() {
        val heap = JvmHeap()
        val localVariables = JvmLocalVariables(maxLocals = 1)
    ...
    @Test
    fun `invokeinterface executes package private receiver class implementation of public interface method`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Impl")
        val callerLocals = JvmLocalVariables(maxLocals = 1)
        callerLocals.store(0, receiver)
    ...
    @Test
    fun `invokeinterface executes more specific child interface default method`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/SpecificImpl")
        val callerLocals = JvmLocalVariables(maxLocals = 1)
        callerLocals.store(0, receiver)
    ...
    fun `invokedynamic materializes bootstrap method guest arguments before bootstrap execution`() {
        ...
        val exception = assertFailsWith<JvmUnsupportedInstructionException> {
            JvmInterpreter.execute(
                ...
                maxStack = 0,
                constantPool = invokedynamicBootstrapInvocationConstantPool(MethodHandleReferenceKind.InvokeVirtual),
                heap = heap,
                currentClassName = "pkg/Caller",
                bootstrapMethods = JvmBootstrapMethodTable(
                    listOf(
        ...
        assertEquals(
            "Unsupported invokedynamic call site #1 run:(I)Ljava/lang/String; bootstrap #0 " +
                "with 4 bootstrap method argument(s) at offset 0: bootstrap method handle InvokeVirtual execution " +
    ...
    @Test
    fun `invokedynamic executes cached linked static call site target`() {
        val classHierarchy = JvmClassHierarchy(
            listOf(
                JvmClassDefinition(
    ...
    fun `invokedynamic cached linked static native target retains native library load hook`() {
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Targets", "answer", "()I", isStatic = true) to
                JvmNativeMethodIntrinsic { context, _ ->
                    context.loadNativeLibraryHandler("indy-static-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-static-native"), loadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }
    ...
    @Test
    fun `invokedynamic cached get static field target executes class initializer`() {
        val staticFields = JvmStaticFields()
        val field = JvmFieldReference(
            ownerClassName = "pkg/Targets",
            name = "answer",
    ...
    @Test
    fun `invokedynamic executes cached put field target`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Targets")
        val field = JvmFieldReference(
            ownerClassName = "pkg/Targets",
        ...
        val callSites = JvmInvokeDynamicCallSiteRegistry()
        callSites.bind(
            key = JvmInvokeDynamicCallSiteKey(ownerClassName = "pkg/Caller", bytecodeOffset = 3),
            callSite = JvmLinkedInvokeDynamicCallSite(
                spec = JvmInvokeDynamicCallSiteSpec(
                    constantPoolIndex = JvmRuntimeConstantPoolIndex(1),
                    bootstrapMethodIndex = 0,
                    name = "store",
                    descriptor = "(Lpkg/Targets;I)V",
                ),
                targetMethodHandle = JvmMethodHandlePayload(
        ...
        val result = JvmInterpreter.execute(
            ...
            maxStack = 2,
            constantPool = invokedynamicFieldSetterCallSiteConstantPool(),
            heap = heap,
            localVariables = locals,
            currentClassName = "pkg/Caller",
            invokeDynamicCallSites = callSites,
        ...
        assertEquals(0, result.operandStack.valueCount)
        assertEquals(JvmIntValue(42), heap.getInstanceField(receiver, field))
    }
    ...
    @Test
    fun `invokedynamic cached linked special interpreted target retains native library unload hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        val unloadedLogicalNames = mutableListOf<String>()
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Helper", "value", "()I", isStatic = true) to
                JvmNativeMethodIntrinsic { context, _ ->
                    context.unloadNativeLibraryHandler("indy-special-interpreted-target")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-special-interpreted-target"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }

    @Test
    fun `invokedynamic cached linked special interpreted target retains monitor unblocked hook`() {
        val heap = JvmHeap()
        val monitor = JvmMonitorState()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        ...
        val result = JvmInterpreter.execute(
            ...
            constantPool = ConstantPool.fromEntries(
                listOf(
                    ...
                    ConstantUtf8Entry("release", "release".encodeToByteArray()),
                    ConstantUtf8Entry("(Lpkg/Base;)V", "(Lpkg/Base;)V".encodeToByteArray()),
                ),
            ),
            heap = heap,
            localVariables = locals,
    ...
    @Test
    fun `invokedynamic cached linked special native target retains native library unload hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        locals.store(0, receiver)
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Base", "answer", "()I", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    assertEquals(receiver, invocation.receiver)
                    context.unloadNativeLibraryHandler("indy-special-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-special-native"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }
    ...
    @Test
    fun `invokedynamic cached linked interface interpreted target retains native library unload hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Impl")
        val locals = JvmLocalVariables(maxLocals = 1)
        val unloadedLogicalNames = mutableListOf<String>()
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Helper", "value", "()I", isStatic = true) to
                JvmNativeMethodIntrinsic { context, _ ->
                    context.unloadNativeLibraryHandler("indy-interface-interpreted-target")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-interface-interpreted-target"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }
    ...
    fun `invokedynamic cached linked interface native target retains native library load hook`() {
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Impl", "value", "()I", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    assertEquals(receiver, invocation.receiver)
                    context.loadNativeLibraryHandler("indy-interface-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-interface-native"), loadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }

    @Test
    fun `invokedynamic cached linked interface native target retains native library unload hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Impl")
        val locals = JvmLocalVariables(maxLocals = 1)
        locals.store(0, receiver)
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Impl", "value", "()I", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    assertEquals(receiver, invocation.receiver)
                    context.unloadNativeLibraryHandler("indy-interface-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-interface-native"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }
    ...
    @Test
    fun `invokedynamic cached linked constructor interpreted target retains native library unload hook`() {
        val heap = JvmHeap()
        val unloadedLogicalNames = mutableListOf<String>()
        val classHierarchy = JvmClassHierarchy(
            listOf(
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Helper", "value", "()I", isStatic = true) to
                JvmNativeMethodIntrinsic { context, _ ->
                    context.unloadNativeLibraryHandler("indy-constructor-interpreted-target")
                    JvmIntValue(42)
                },
        )
        ...
        val constructed = result.operandStack.toList().single() as JvmObjectReferenceValue
        assertEquals(listOf("indy-constructor-interpreted-target"), unloadedLogicalNames)
        assertEquals("pkg/Constructed", heap.get(constructed).className)
        assertTrue(heap.isInitialized(constructed))
    }
    ...
    fun `invokedynamic cached linked native constructor target retains native library load hook`() {
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Constructed", "<init>", "()V", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    ...
                    context.loadNativeLibraryHandler("indy-constructor-native")
                    null
                },
        )
        ...
        val constructed = result.operandStack.toList().single() as JvmObjectReferenceValue
        assertEquals(listOf("indy-constructor-native"), loadedLogicalNames)
        assertEquals("pkg/Constructed", heap.get(constructed).className)
        assertTrue(heap.isInitialized(constructed))
    }
    ...
    fun `invokedynamic rejects field method handles without linked field targets`() {
        ...
        assertEquals(
            "Invalid invokedynamic putfield target for answer:()I at offset 0: linked target is not a field",
            exception.message,
        )
    }

    @Test
    fun `invokedynamic executes cached invoke virtual target using receiver dispatch`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        locals.store(0, receiver)
    ...
    @Test
    fun `invokedynamic cached linked virtual native target retains native library load hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        locals.store(0, receiver)
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Child", "value", "()I", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    assertEquals(receiver, invocation.receiver)
                    context.loadNativeLibraryHandler("indy-virtual-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-virtual-native"), loadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }

    @Test
    fun `invokedynamic cached linked virtual native target retains native library unload hook`() {
        val heap = JvmHeap()
        val receiver = heap.allocateObject("pkg/Child")
        val locals = JvmLocalVariables(maxLocals = 1)
        locals.store(0, receiver)
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey("pkg/Child", "value", "()I", isStatic = false) to
                JvmNativeMethodIntrinsic { context, invocation ->
                    assertEquals(receiver, invocation.receiver)
                    context.unloadNativeLibraryHandler("indy-virtual-native")
                    JvmIntValue(42)
                },
        )
        ...
        assertEquals(listOf("indy-virtual-native"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
    }
    ...
    @Test
    fun `invokedynamic native bootstrap retains native library unload hook`() {
        val heap = JvmHeap()
        val unloadedLogicalNames = mutableListOf<String>()
        val bootstrapDescriptor =
            "(Ljava/lang/invoke/MethodHandles\$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;)" +
        ...
        val nativeMethods = JvmNativeMethodRegistry.from(
            JvmNativeMethodKey(
                ...
                assertEquals(3, invocation.arguments.size)
                context.unloadNativeLibraryHandler("indy-bootstrap-native")
                context.heap.allocateCallSite(
                    context.heap.internMethodHandle(
                        referenceKind = JvmMethodHandleReferenceKind.InvokeStatic,
                        referenceIndex = 12,
        ...
        assertEquals(listOf("indy-bootstrap-native"), unloadedLogicalNames)
        assertEquals(listOf(JvmIntValue(42)), result.operandStack.toList())
        assertEquals(
            classHierarchy.resolveMethod("pkg/Targets", "answer", "()I"),
            callSites.linked(JvmInvokeDynamicCallSiteKey("pkg/Caller", 0))?.targetMethod,
    ...
    private fun invokedynamicVirtualReceiverCallSiteConstantPool(): ConstantPool =
        ConstantPool.fromEntries(
            listOf(
                ConstantInvokeDynamicEntry(
                    bootstrapMethodIndex = BootstrapMethodIndex(0),
    ...
    private fun invokedynamicFieldSetterCallSiteConstantPool(): ConstantPool =
        ConstantPool.fromEntries(
            listOf(
                ConstantInvokeDynamicEntry(
                    bootstrapMethodIndex = BootstrapMethodIndex(0),
                ...
                ConstantUtf8Entry("store", "store".encodeToByteArray()),
                ConstantUtf8Entry("(Lpkg/Targets;I)V", "(Lpkg/Targets;I)V".encodeToByteArray()),
            ),
        )

    private fun invokedynamicInterfaceReceiverCallSiteConstantPool(): ConstantPool =
        ConstantPool.fromEntries(
            listOf(
                ConstantInvokeDynamicEntry(
                    bootstrapMethodIndex = BootstrapMethodIndex(0),
    ...
    private fun invokedynamicBootstrapExecutionConstantPool(bootstrapDescriptor: String): ConstantPool =
        ConstantPool.fromEntries(
            listOf(
                ConstantInvokeDynamicEntry(
                    bootstrapMethodIndex = BootstrapMethodIndex(0),
    ...
    private fun invokedynamicBootstrapInvocationConstantPool(
        bootstrapReferenceKind: MethodHandleReferenceKind = MethodHandleReferenceKind.InvokeStatic,
    ): ConstantPool =
        ConstantPool.fromEntries(
            listOf(
