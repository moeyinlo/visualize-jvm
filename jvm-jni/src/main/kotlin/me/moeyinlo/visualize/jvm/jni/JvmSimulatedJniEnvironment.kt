...
class JvmSimulatedJniEnvironment(
    ...
    fun newWeakGlobalRef(handle: JvmJniHandleId?): JvmJniHandleId? =
        handle?.let { localHandle -> handles.newWeakGlobalReference(handles.snapshotLocalReference(localHandle)) }
    ...
    fun callNonvirtualObjectMethod(
        ...
        return when (
            val result = upcallDispatcher.callNonvirtualObjectMethod(
                receiver = receiver,
                method = method,
                arguments = arguments,
            )
    ...
    fun callNonvirtualCharMethod(
        ...
        return upcallDispatcher.callNonvirtualCharMethod(
            receiver = receiver,
            method = method,
            arguments = arguments,
        ).value
    ...
    fun callNonvirtualShortMethod(
        ...
        return upcallDispatcher.callNonvirtualShortMethod(
            receiver = receiver,
            method = method,
            arguments = arguments,
        ).value
