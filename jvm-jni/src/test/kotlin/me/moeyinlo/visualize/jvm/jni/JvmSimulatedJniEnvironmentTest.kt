...
class JvmSimulatedJniEnvironmentTest {
    ...
    @Test
    fun `UnregisterNatives removes only entries for the class handle loaded class key`() {
        val handles = JvmJniHandleTable()
        val registry = JvmJniNativeMethodRegistry()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val firstHandle = handles.newClassHandle("pkg/NativeApi", firstKey)
        val secondHandle = handles.newClassHandle("pkg/NativeApi", secondKey)
        environment.registerNatives(firstHandle, listOf(JvmJniNativeMethodDescriptor("a", "()V", 0x1111L)))
        environment.registerNatives(secondHandle, listOf(JvmJniNativeMethodDescriptor("a", "()V", 0x2222L)))

        environment.unregisterNatives(firstHandle)
    ...
    @Test
    fun `GetSuperclass throws guest NoClassDefFoundError when the direct superclass is not loaded`() {
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
                listOf(
                    JvmClassDefinition(internalName = "pkg/Child", superclassName = "pkg/MissingBase"),
                ),
            ),
        )
        val childHandle = environment.findClass("pkg/Child")

        val exception = assertFailsWith<JvmNoClassDefFoundError> {
            environment.getSuperclass(childHandle)
        }

        assertEquals("java/lang/NoClassDefFoundError", exception.guestClassName)
        assertEquals("pkg/MissingBase", exception.message)
    }
    ...
    @Test
    fun `GetModule returns the element class module for reference array class handles`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val moduleReference = heap.allocateObject("java/lang/Module")
        val environment = JvmSimulatedJniEnvironment(
        ...
        val moduleHandle = environment.getModule(arrayClassHandle)
    ...
    @Test
    fun `GetStaticMethodID returns method IDs that survive local frame pop`() {
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
                listOf(
        ...
        environment.pushLocalFrame(4)
        val classHandle = environment.findClass("Example")
        val methodHandle = environment.getStaticMethodId(classHandle, "value", "()I")
    ...
    @Test
    fun `CallVoidMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedVoidUpcall>()
        val environment = JvmSimulatedJniEnvironment(
        ...
        val methodHandle = environment.getMethodId(classClassHandle, "touchMirror", "()V")

        environment.callVoidMethod(receiverClassHandle, methodHandle)
    ...
    @Test
    fun `CallNonvirtualVoidMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedVoidUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                override fun callVoidMethod(
                    ...
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ) = error("CallNonvirtualVoidMethod must not use the virtual CallVoidMethod boundary")
    ...
    @Test
    fun `CallNonvirtualVoidMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedVoidUpcall>()
        val environment = JvmSimulatedJniEnvironment(
    ...
    @Test
    fun `CallNonvirtualObjectMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedObjectUpcall>()
        val resultReference = heap.allocateObject("java/lang/Object")
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callObjectMethod(
                    ...
                    error("CallNonvirtualObjectMethod must not use the virtual CallObjectMethod boundary")

                override fun callNonvirtualObjectMethod(
                    receiver: JvmObjectReferenceValue,
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ): JvmReferenceValue {
    ...
    @Test
    fun `CallNonvirtualCharMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedCharUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callCharMethod(
                    ...
                    error("CallNonvirtualCharMethod must not use the virtual CallCharMethod boundary")

                override fun callNonvirtualCharMethod(
                    receiver: JvmObjectReferenceValue,
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ): JvmCharValue {
    ...
    @Test
    fun `CallNonvirtualCharMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedCharUpcall>()
        val environment = JvmSimulatedJniEnvironment(
    ...
    @Test
    fun `CallNonvirtualIntMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedIntUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callIntMethod(
                    ...
                    error("CallNonvirtualIntMethod must not use the virtual CallIntMethod boundary")

                override fun callNonvirtualIntMethod(
                    receiver: JvmObjectReferenceValue,
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ): JvmIntValue {
                    calls += RecordedIntUpcall(receiver, method, arguments)
                    return JvmIntValue(654322)
                }
            },
        )
        val baseClassHandle = environment.findClass("Base")
    ...
    @Test
    fun `CallNonvirtualIntMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedIntUpcall>()
        val environment = JvmSimulatedJniEnvironment(
    ...
    @Test
    fun `CallLongMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedLongUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callLongMethod(
                    ...
                    calls += RecordedLongUpcall(receiver, method, arguments)
                    return JvmLongValue(7_654_321L)
                }
            },
        )
        val receiverClassHandle = environment.findClass("Example")
        val classClassHandle = environment.findClass("java/lang/Class")
        val methodHandle = environment.getMethodId(classClassHandle, "mirrorWide", "()J")

        val result = environment.callLongMethod(receiverClassHandle, methodHandle)

        assertEquals(7_654_321L, result)
        assertEquals(
            listOf(
                RecordedLongUpcall(
                    receiver = heap.internClassMirror("Example"),
    ...
    @Test
    fun `CallNonvirtualLongMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedLongUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callLongMethod(
                    ...
                    error("CallNonvirtualLongMethod must not use the virtual CallLongMethod boundary")

                override fun callNonvirtualLongMethod(
                    receiver: JvmObjectReferenceValue,
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ): JvmLongValue {
        ...
        val result = environment.callNonvirtualLongMethod(
            ...
            classHandle = baseClassHandle,
            methodIdHandle = methodHandle,
            arguments = listOf(JvmIntValue(24)),
        )
    ...
    @Test
    fun `CallNonvirtualLongMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedLongUpcall>()
        val environment = JvmSimulatedJniEnvironment(
    ...
    @Test
    fun `CallFloatMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedFloatUpcall>()
        val environment = JvmSimulatedJniEnvironment(
        ...
        val receiverClassHandle = environment.findClass("Example")
        val classClassHandle = environment.findClass("java/lang/Class")
        val methodHandle = environment.getMethodId(classClassHandle, "mirrorRatio", "()F")

        val result = environment.callFloatMethod(receiverClassHandle, methodHandle)
    ...
    @Test
    fun `CallNonvirtualFloatMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedFloatUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callFloatMethod(
                    ...
                    error("CallNonvirtualFloatMethod must not use the virtual CallFloatMethod boundary")
        ...
        val result = environment.callNonvirtualFloatMethod(
            ...
            classHandle = baseClassHandle,
            methodIdHandle = methodHandle,
            arguments = listOf(JvmIntValue(30)),
        )
    ...
    @Test
    fun `CallNonvirtualFloatMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedFloatUpcall>()
        val environment = JvmSimulatedJniEnvironment(
    ...
    @Test
    fun `CallDoubleMethod accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedDoubleUpcall>()
        val environment = JvmSimulatedJniEnvironment(
        ...
        val result = environment.callDoubleMethod(receiverClassHandle, methodHandle)
    ...
    @Test
    fun `CallNonvirtualDoubleMethod uses nonvirtual upcall dispatcher boundary`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val calls = mutableListOf<RecordedDoubleUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callDoubleMethod(
                    ...
                    error("CallNonvirtualDoubleMethod must not use the virtual CallDoubleMethod boundary")

                override fun callNonvirtualDoubleMethod(
                    receiver: JvmObjectReferenceValue,
                    method: JvmResolvedMethod,
                    arguments: List<JvmValue>,
                ): JvmDoubleValue {
                    calls += RecordedDoubleUpcall(receiver, method, arguments)
                    return JvmDoubleValue(10.125)
                }
            },
        )
        val baseClassHandle = environment.findClass("Base")
        ...
        val result = environment.callNonvirtualDoubleMethod(
            ...
            classHandle = baseClassHandle,
            methodIdHandle = methodHandle,
            arguments = listOf(JvmIntValue(32)),
        )

        assertEquals(10.125, result)
        assertEquals(
            listOf(
                RecordedDoubleUpcall(
                    receiver = receiver,
        ...
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callStaticVoidMethod(
                    ...
                    calls += RecordedStaticVoidUpcall(method, arguments, currentLoadedClassKey)
                }
            },
        )
        val classHandle = environment.findClass("Example")
    ...
    @Test
    fun `CallStaticVoidMethod passes class handle loaded class key to the upcall dispatcher`() {
        val handles = JvmJniHandleTable()
        val loader = JvmClassLoaderIdentity.UserDefined(id = 401, displayName = "jni-upcall-loader")
        ...
        val methodHandle = environment.getStaticMethodId(classHandle, "boot", "()V")

        environment.callStaticVoidMethod(classHandle, methodHandle)
        ...
        val environment = JvmSimulatedJniEnvironment(
            ...
            upcallDispatcher = object : JvmJniUpcallDispatcher {
                ...
                override fun callStaticByteMethod(
                    ...
                    calls += RecordedStaticByteUpcall(method, arguments, currentLoadedClassKey)
                    return JvmByteValue(-12)
                }
            },
        )
    ...
    @Test
    fun `CallStaticByteMethod passes class handle loaded class key to the upcall dispatcher`() {
        val handles = JvmJniHandleTable()
        val loader = JvmClassLoaderIdentity.UserDefined(id = 404, displayName = "jni-upcall-loader")
        val loadedClassKey = JvmLoadedClassKey("Example", loader)
        val calls = mutableListOf<RecordedStaticByteUpcall>()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val classHandle = handles.newClassHandle("Example", loadedClassKey = loadedClassKey)
        val methodHandle = environment.getStaticMethodId(classHandle, "code", "()B")

        val result = environment.callStaticByteMethod(classHandle, methodHandle)
    ...
    @Test
    fun `AllocObject prepares default instance fields from class hierarchy layout`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
    ...
    @Test
    fun `IsInstanceOf throws guest NoClassDefFoundError when target class handle is not loaded`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val objectHandle = handles.newObjectHandle(heap.allocateObject("Example"))
        val missingClassHandle = handles.newClassHandle("Missing")

        val exception = assertFailsWith<JvmNoClassDefFoundError> {
            environment.isInstanceOf(objectHandle, missingClassHandle)
        }
    ...
    @Test
    fun `GetIntField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val receiverClassHandle = environment.findClass("Example")
        val classClassHandle = environment.findClass("java/lang/Class")
        val fieldHandle = environment.getFieldId(classClassHandle, "mirrorValue", "I")
        val mirrorReference = heap.internClassMirror("Example")
        heap.putInstanceField(
            mirrorReference,
            JvmFieldReference(ownerClassName = "java/lang/Class", name = "mirrorValue", descriptor = "I"),
            JvmIntValue(84),
        )

        val result = environment.getIntField(receiverClassHandle, fieldHandle)
    ...
    @Test
    fun `SetIntField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setIntField(receiverClassHandle, fieldHandle, 126)
    ...
    @Test
    fun `SetObjectField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val mirrorReference = heap.internClassMirror("Example")
        val targetReference = heap.allocateObject("Target")
        val targetHandle = handles.newObjectHandle(targetReference)

        environment.setObjectField(receiverClassHandle, fieldHandle, targetHandle)
    ...
    @Test
    fun `SetLongField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setLongField(receiverClassHandle, fieldHandle, 1_234_567_890L)

        assertEquals(
            JvmLongValue(1_234_567_890L),
            heap.getInstanceField(
                mirrorReference,
                JvmFieldReference(ownerClassName = "java/lang/Class", name = "mirrorValue", descriptor = "J"),
            ),
    ...
    @Test
    fun `SetFloatField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setFloatField(receiverClassHandle, fieldHandle, 4.5f)
    ...
    @Test
    fun `GetDoubleField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val receiverClassHandle = environment.findClass("Example")
        val classClassHandle = environment.findClass("java/lang/Class")
        val fieldHandle = environment.getFieldId(classClassHandle, "mirrorValue", "D")
        val mirrorReference = heap.internClassMirror("Example")
        heap.putInstanceField(
            mirrorReference,
            JvmFieldReference(ownerClassName = "java/lang/Class", name = "mirrorValue", descriptor = "D"),
            JvmDoubleValue(7.125),
        )

        val result = environment.getDoubleField(receiverClassHandle, fieldHandle)

        assertEquals(7.125, result)
    }
    ...
    @Test
    fun `SetDoubleField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setDoubleField(receiverClassHandle, fieldHandle, 8.25)
    ...
    @Test
    fun `SetBooleanField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setBooleanField(receiverClassHandle, fieldHandle, true)
    ...
    @Test
    fun `GetByteField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        val result = environment.getByteField(receiverClassHandle, fieldHandle)
    ...
    @Test
    fun `SetCharField accepts jclass receivers as guest Class mirror objects`() {
        val heap = JvmHeap()
        val handles = JvmJniHandleTable()
        val environment = JvmSimulatedJniEnvironment(
            classHierarchy = JvmClassHierarchy(
        ...
        environment.setCharField(receiverClassHandle, fieldHandle, '类'.code)
    ...
    fun `ExceptionDescribe reports pending throwable without clearing it`() {
        ...
        assertEquals(true, environment.exceptionCheck())
        assertEquals(
            handles.resolveObject(environment.exceptionOccurred()!!),
            environment.pendingExceptionReference,
        )
    }
