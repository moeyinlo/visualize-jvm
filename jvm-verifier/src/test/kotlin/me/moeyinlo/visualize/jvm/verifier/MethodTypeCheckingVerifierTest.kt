...
class MethodTypeCheckingVerifierTest {
    ...
    @Test
    fun `type checking verifier applies tableswitch operand stack transition`() {
        val tableswitch = byteArrayOf(
            0xAA.toByte(),
    ...
    @Test
    fun `type checking verifier applies anewarray operand stack transition at explicit source frames`() {
        MethodTypeCheckingVerifier.verify(
            code = code(
                maxStack = 1,
                maxLocals = 0,
                code = byteArrayOf(
                    0xBD.toByte(), 0x00.toByte(), 0x1F.toByte(),
                    0xB1.toByte(),
                ),
            ),
            frameStates = listOf(
    ...
    @Test
    fun `type checking verifier applies getstatic operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xB2.toByte(), 0x00.toByte(), 0x06.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
    ...
    @Test
    fun `type checking verifier applies getfield operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("pkg/Owner", "pkg/Owner".encodeToByteArray()),
                ConstantClassEntry(ConstantPoolIndex(1)),
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xB4.toByte(), 0x00.toByte(), 0x06.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
            frameStates = listOf(
                VerificationFrameState(
                    bytecodeOffset = 0,
                    locals = emptyList(),
                    stack = listOf(VerificationType.ClassType("pkg/Owner")),
                ),
            ),
        )
        ...
        assertEquals(
            "Operand stack top contains Float, expected ClassType(internalName=pkg/Owner, loader=bootstrap)",
            exception.message,
        )
    }

    @Test
    fun `type checking verifier applies putfield operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("pkg/Owner", "pkg/Owner".encodeToByteArray()),
                ConstantClassEntry(ConstantPoolIndex(1)),
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xB5.toByte(), 0x00.toByte(), 0x06.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
            frameStates = listOf(
                VerificationFrameState(
                    bytecodeOffset = 0,
                    locals = emptyList(),
                    stack = listOf(VerificationType.ClassType("pkg/Owner"), VerificationType.Integer),
                ),
            ),
        )
    ...
    @Test
    fun `type checking verifier applies invokevirtual operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ConstantUtf8Entry("pkg/Owner", "pkg/Owner".encodeToByteArray()),
                ConstantClassEntry(ConstantPoolIndex(1)),
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xB6.toByte(), 0x00.toByte(), 0x06.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
    ...
    fun `type checking verifier applies invokestatic operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
                ...
                ConstantUtf8Entry("(I)D", "(I)D".encodeToByteArray()),
                ConstantNameAndTypeEntry(
                    nameIndex = ConstantPoolIndex(3),
                    descriptorIndex = ConstantPoolIndex(4),
                ),
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xB8.toByte(), 0x00.toByte(), 0x06.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
    ...
    @Test
    fun `type checking verifier applies invokedynamic operand stack transition at explicit source frames`() {
        val constantPool = ConstantPool.fromEntries(
            listOf(
        ...
        MethodTypeCheckingVerifier.verify(
            code = code(
                ...
                maxLocals = 0,
                code = byteArrayOf(
                    0xBA.toByte(), 0x00.toByte(), 0x04.toByte(), 0x00.toByte(), 0x00.toByte(),
                    0xB1.toByte(),
                ),
            ),
            constantPool = constantPool,
    ...
    @Test
    fun `type checking verifier applies athrow operand stack transition from initial frame`() {
        val throwableType = VerificationType.ObjectType(ConstantPoolIndex(11))
