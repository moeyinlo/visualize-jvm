...
object CharArrayLoadInstructionVerifier {
    private const val EXPECTED_ARRAY_REFERENCE = "char or null array reference"
    ...
    fun verify(
        ...
        if (!arrayRef.isCharArrayReference()) {
    ...
    private fun VerificationType.isCharArrayReference(): kotlin.Boolean =
        this == VerificationType.Null ||
            this == VerificationType.ArrayOf(VerificationType.Char)
}
