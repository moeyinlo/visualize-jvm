...
object FloatCompareGreaterInstructionVerifier {
    fun verify(frame: VerificationFrameState, maxStack: Int): VerificationFrameState {
        ...
        val withoutValue2 = stack.pop(VerificationType.Float)
        val withoutValue1 = withoutValue2.stack.pop(VerificationType.Float)
