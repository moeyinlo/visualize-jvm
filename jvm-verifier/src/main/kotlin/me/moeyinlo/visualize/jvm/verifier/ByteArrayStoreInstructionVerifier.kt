...
object ByteArrayStoreInstructionVerifier {
    ...
    fun verify(
        ...
        if (!arrayRef.isByteOrBooleanArrayReference()) {
    ...
    private fun VerificationType.isByteOrBooleanArrayReference(): kotlin.Boolean =
        when (this) {
